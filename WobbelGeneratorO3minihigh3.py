...
# Update functions for scales and entry widgets
...
volume_scale = tk.Scale(root, from_=0.0, to=1.0, resolution=0.01, orient=tk.HORIZONTAL,
                        command=lambda val: params.update({'volume': float(val)}))
volume_scale.set(0.5)
volume_scale.grid(row=5, column=1, columnspan=2)
