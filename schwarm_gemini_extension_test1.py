...
default_values_swarm5 = { # NEU
    'boid_count': 40, 'separation_factor': 1.7, 'alignment_factor': 0.9, 'cohesion_factor': 1.1,
    'visual_range': 75.0, 'separation_distance': 26.0, 'avoidance_factor': 3.2, 'avoidance_range': 85.0,
    'max_speed': 4.2, 'max_force': 0.2,
    # Eigene Geometrie für Gelb
    'geom_tip_factor': 1.8, 'geom_mid_offset_factor': 0.1, 'geom_width_factor': 0.65,
    'geom_tail_offset_factor': 1.0, 'geom_tail_width_factor': 0.25,
}
...
def replenish_swarm(params_dict):
    ...
    elif params_dict is params3: target_swarm = swarm3; swarm_name = "Schwarm 3 (Lila)"
    elif params_dict is params4: target_swarm = swarm4; swarm_name = "Schwarm 4 (Grün)" # NEU
    elif params_dict is params5: target_swarm = swarm5; swarm_name = "Schwarm 5 (Gelb)"
    if target_swarm:
        try:
            ...
            if target_count > current_count:
                if target_swarm.update_boid_count(target_count): # True wenn hinzugefügt wurde
                    ...
                    all_boids = swarm1.boids + swarm2.boids + swarm3.boids + swarm4.boids + swarm5.boids
...
def setup_tkinter_controls():
    ...
    params_swarm1 = {}; params_swarm2 = {}; params_swarm3 = {}; params_swarm4 = {}; params_swarm5 = {}
    params_shark = {}
    ...
    # --- Tab Schwarm 5 (Gelb) --- NEU
    frame5 = ttk.Frame(notebook, padding="10")
    notebook.add(frame5, text='Gelb')
    last_row5 = create_sliders(frame5, params_swarm5, default_values_swarm5)
    button5 = ttk.Button(frame5, text="Auffüllen", command=lambda p=params_swarm5: replenish_swarm(p))
    button5.grid(row=last_row5, column=0, columnspan=4, pady=(10, 0))
    ...
    return root, params_swarm1, params_swarm2, params_swarm3, params_swarm4, params_swarm5, params_shark


# --- Hauptteil ---
if __name__ == "__main__":
    # Hole alle Parameter-Dictionaries
    root, params1, params2, params3, params4, params5, params_shark = setup_tkinter_controls() # << Angepasst
    pygame.init()
    pygame.font.init()
    ...
    try:
        ...
        swarm3 = Swarm(0, PURPLE, params3); 
        swarm4 = Swarm(0, GREEN, params4) # NEU
        swarm5 = Swarm(0, YELLOW, params5)
        ...
        swarm5.initialize_boids(int(default_values_swarm5['boid_count'])) # NEU
        all_boids = swarm1.boids + swarm2.boids + swarm3.boids + swarm4.boids  + swarm5.boids# NEU

        # Haie als Liste erstellen (initial leer, wird in Schleife gefüllt)
        global sharks # Globale Liste für Haie
        sharks = []

        print(f"Init: S1={len(swarm1.boids)}, S2={len(swarm2.boids)}, S3={len(swarm3.boids)}, S4={len(swarm4.boids)}, S5={len(swarm5.boids)}. Haie initial: {len(sharks)}")
    ...
    def simulation_update():
        ...
        global params1, params2, params3, params4, params5, params_shark
        ...
        try:
            ...
            # Schwarm 5 NEU
            target_count5 = params5['boid_count'].get(); current_count5 = len(swarm5.boids)
            if target_count5 < current_count5:
                 if swarm5.update_boid_count(target_count5): rebuild_all_boids_due_to_slider = True
        ...
        if shark_is_active and sharks:
            ...
            if eaten_this_frame:
                ...
                old_s5_count = len(swarm5.boids) # NEU
                swarm5.boids = [b for b in swarm5.boids if b not in eaten_this_frame]
        ...
        try:
            ...
            if len(all_boids) > 0:
                 ...
                 swarm5.run(screen, all_entities)
        ...
        try:
            if root.winfo_exists():
                ...
                actual_count5 = len(swarm5.boids) # NEU
                ...
                if 'boid_count_actual_label' in params5: params5['boid_count_actual_label'].config(text=f"Aktuell: {actual_count5}") # NEU
