...
def on_click(button_text):
    if button_text == "=":
        try:
            ...
            messagebox.showerror("Fehler", "Doofkopp")
    elif button_text == "C":
        entry_var.set("")
        ...
        try:
            ...
            messagebox.showerror("Fehler", "Sinus von waaas???")
        ...
        try:
            ...
            messagebox.showerror("Fehler", "Bist du bescheuert?")
    else:
...
button_width = 6  # Einheitliche Breite für alle Buttons
button_height = 2

for row_index, row in enumerate(buttons):
    for col_index, text in enumerate(row):
        button = tk.Button(root, text=text, font=("Arial", 16), width=button_width, height=button_height,
