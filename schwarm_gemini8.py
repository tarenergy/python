...
def setup_tkinter_controls():
    ...
    create_sliders(frame_geometry, params_geometry, default_values_geometry)
...
if __name__ == "__main__":
    ...
    def simulation_update():
        ...
        try:
             ...
             shark.eat_radius_sq = eat_radius_sq
        except tk.TclError: pass
        ...
        for boid in boids_to_check:
            try:
                ...
                if dist_sq < eat_radius_sq: eaten_this_frame.add(boid)
